...
class AppLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'off': 'Off',
      'remaining': 'Remaining',
      'water_excellent': 'Your Water Is Healthy!',
      'water_good': 'Water Quality is Good',
      'water_poor': 'Water Quality Needs Attention',
      'water_critical': 'Water Quality Critical',
      ...
      'ai_insight_default': 'Great news! Your groundwater level and water quality are in excellent condition. Keep up the good work!',
      'ask_jal_shayak': 'Ask Jal Shayak',
      'quick_overview': 'Quick Overview',
      'view_analytics': 'View Analytics',
      'water_saved_month': 'Water Saved This Month',
      'liters': 'Liters',
      'keep_conserving': 'Keep conserving! You\'re doing great.',
      'vs_last_month': 'vs last month',
      'download_report': 'Download Water Report',
      'download_report_desc': 'PDF · pH, TDS, Depth, AI Analysis',
      'writing_report': 'Jal Dharan AI is writing your report...',
      'wait_data_load': 'Wait for data to load completely before generating report.',
      'detailed_sensor_data': 'Detailed Sensor Data',
      'from_last_week': 'from last week',
      'extracted': 'Extracted',
      'lifetime': 'Lifetime',
      'previous_avg': 'Previous Avg',
      'community_avg': 'Community Avg',
      'current_vs_average': 'Current vs Average',
      'best_time_pump': 'Best Time to Pump',
      'optimal_time_desc': 'Optimal time based on usage pattern\nand energy efficiency.',
      ...
      // Gamification V2
      'gamification_subtitle': 'Earn points, complete tasks\nand climb the leaderboard!',
      'rank_hash': 'Rank #{rank}',
      'pts': 'PTS',
      'xp_format': '{current} / 5,000 XP',
      'you_label': 'You',
      'keep_going': 'Keep going, Aditya! 💧',
      'all_tasks': 'All Tasks',
      'accept': 'Accept',
      'accept_task_btn': 'Accept Task',
      'points_earned_snackbar': '🎉 +{points} points earned! Keep it up!',
      ...
      'location_permanently_denied': 'Location permission permanently denied',
      'unable_fetch_location': 'Unable to fetch location',
      'groundwater_guardian': 'Groundwater Guardian',
      ...
      'dark_mode': 'Dark Mode',
      'dark_mode_desc': 'Reduce eye strain in low light',
      'notifications_desc': 'Stay updated with important alerts',
    ...
    'hi': {
      ...
      'off': 'बंद',
      'remaining': 'शेष',
      'water_excellent': 'आपका पानी स्वस्थ है!',
      'water_good': 'पानी की गुणवत्ता अच्छी है',
      'water_poor': 'पानी की गुणवत्ता पर ध्यान देने की आवश्यकता है',
      'water_critical': 'पानी की गुणवत्ता गंभीर है',
      ...
      'ai_insight_default': 'खुशखबरी! आपका भूजल स्तर और पानी की गुणवत्ता उत्कृष्ट स्थिति में है। ऐसे ही लगे रहें!',
      'ask_jal_shayak': 'जल शायक से पूछें',
      'quick_overview': 'त्वरित अवलोकन',
      'view_analytics': 'विश्लेषण देखें',
      'water_saved_month': 'इस महीने बचाया गया पानी',
      'liters': 'लीटर',
      'keep_conserving': 'संरक्षण करते रहें! आप बहुत अच्छा कर रहे हैं।',
      'vs_last_month': 'पिछले महीने की तुलना में',
      'download_report': 'जल रिपोर्ट डाउनलोड करें',
      'download_report_desc': 'पीडीएफ · pH, TDS, गहराई, AI विश्लेषण',
      'writing_report': 'जल धरण AI आपकी रिपोर्ट लिख रहा है...',
      'wait_data_load': 'रिपोर्ट उत्पन्न करने से पहले डेटा पूरी तरह से लोड होने की प्रतीक्षा करें।',
      'detailed_sensor_data': 'विस्तृत सेंसर डेटा',
      'from_last_week': 'पिछले सप्ताह से',
      'extracted': 'निकाला गया',
      'lifetime': 'जीवनकाल',
      'previous_avg': 'पिछला औसत',
      'community_avg': 'सामुदायिक औसत',
      'current_vs_average': 'वर्तमान बनाम औसत',
      'best_time_pump': 'पंप करने का सबसे अच्छा समय',
      'optimal_time_desc': 'उपयोग पैटर्न और ऊर्जा दक्षता के आधार पर इष्टतम समय।',
      ...
      // Gamification V2 (Hindi)
      'gamification_subtitle': 'अंक अर्जित करें, कार्य पूरे करें\nऔर लीडरबोर्ड पर चढ़ें!',
      'rank_hash': 'रैंक #{rank}',
      'pts': 'PTS',
      'xp_format': '{current} / 5,000 XP',
      'you_label': 'आप',
      'keep_going': 'लगे रहें, आदित्य! 💧',
      'all_tasks': 'सभी कार्य',
      'accept': 'स्वीकार करें',
      'accept_task_btn': 'कार्य स्वीकार करें',
      'points_earned_snackbar': '🎉 +{points} अंक अर्जित! लगे रहें!',

      // Profile Screen (Hindi)
      'profile_subtitle': 'अपना खाता और प्राथमिकताएं प्रबंधित करें',
      'fetching_location': 'स्थान प्राप्त किया जा रहा है...',
      'location_denied': 'स्थान अनुमति अस्वीकृत',
      'location_permanently_denied': 'स्थान अनुमति स्थायी रूप से अस्वीकृत',
      'unable_fetch_location': 'स्थान प्राप्त करने में असमर्थ',
      'groundwater_guardian': 'भूजल संरक्षक',
      'water_points': 'जल अंक',
      ...
      'dark_mode': 'डार्क मोड',
      'dark_mode_desc': 'कम रोशनी में आंखों पर जोर कम करें',
      'notifications_desc': 'महत्वपूर्ण अलर्ट से अपडेट रहें',
